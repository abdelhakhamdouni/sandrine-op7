  ...
  <div class="about">
    ...
    <section class="Actu">
      ...
      <div class="container wallMessage">
        <Post v-for="message in response" :key="message.id" :message="message.message" :fileToDisplay="message.attachement" :user_prenom="message.user.prenom" :user_nom="message.user.nom" :messageId="message.id" :createdAt="message.createdAt" class="allPost"></Post>
      </div>
    </section>
  </div>
</template>
